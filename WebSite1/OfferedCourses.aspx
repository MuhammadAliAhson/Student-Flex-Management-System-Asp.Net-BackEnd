    ...
    <form id="form2" runat="server">
        <div class="courses-container">
            ...
            <asp:DropDownList ID="ddlSemesters" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSemesters_SelectedIndexChanged">
                <asp:ListItem>SEM001</asp:ListItem>
                <asp:ListItem>SEM002</asp:ListItem>
                <asp:ListItem>SEM003</asp:ListItem>
                <asp:ListItem>SEM004</asp:ListItem>
                <asp:ListItem>SEM005</asp:ListItem>
            </asp:DropDownList>
            <asp:GridView ID="myGridView" runat="server" AutoGenerateColumns="true"></asp:GridView>
            <asp:Button ID="Button1" runat="server" CssClass="generate-results" Text="Generate Results" OnClick="btnGenerateResults_Click" />
        </div>
    </form>
</body>
</html>
