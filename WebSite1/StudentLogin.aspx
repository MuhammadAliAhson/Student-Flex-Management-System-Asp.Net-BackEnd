...
<body>
    <div class="welcome-banner">Welcome to Flex - Student Login</div>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-group">
                <button type="button" class="btn btn-secondary btn-block" data-toggle="modal" data-target="#signupModal" runat="server" OnClick="SignUp_Click">Sign Up</button>
            </div>
        </div>
    </form>
